...
contract ClockAuctionBase {
    ...
    function removeIdFromAuctions(uint256 _valueToFindAndRemove) {
        ...
        returns (uint256)
    {
        ...
        if (price > 0) {
            ...
            fox.transferFrom(msg.sender, seller, sellerProceeds);
        }
        ...
        // fox.transferFrom(this, msg.sender, bidExcess);
...
contract ClockAuction is Pausable, ClockAuctionBase {
    ...
    function ClockAuction(address _nftAddress, address _foxAddress, uint256 _cut) public {
        require(_cut <= 10000);
        ownerCut = _cut;

        ERC721 candidateContract = ERC721(_nftAddress);
        FOX foxCandidateContract = FOX(_foxAddress);
        // require(candidateContract.supportsInterface(InterfaceSignature_ERC721));
        nonFungibleContract = candidateContract;
        fox = foxCandidateContract;
    }
...
contract SaleClockAuction is ClockAuction {
    ...
    function SaleClockAuction(address _nftAddr, address _foxAddr, uint256 _cut) public
        ClockAuction(_nftAddr, _foxAddr, _cut) {}
